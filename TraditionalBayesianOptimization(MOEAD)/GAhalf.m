function Offspring = GAhalf(Parent,Boundary)
% Offspring = GAhalf(Parent,Parameter)
...
%             Upper = repmat(Global.upper,N,1);
            Upper = repmat(Boundary(1,:),N,1);%矩阵重复，以Boundary(1,:)为矩阵元素，重复MaxOffspring行1列，即最后的矩阵为MaxOffspring*D维的全1矩阵
